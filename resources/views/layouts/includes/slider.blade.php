<div id="hero-area">
    ...
    <body
        ...
        <div id="jssor_1"
            style="position:relative;margin:0 auto;top:0px;left:0px;width:1600px;height:600px;overflow:hidden;visibility:hidden;">

            <div data-u="slides"
                style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:600px;overflow:hidden;">

                <div>
                    <img data-u="image" data-src="{{ asset('data/slider/2.jpeg') }}" />
                </div>
                ...
                <div>
                    <img data-u="image" data-src="{{ asset('data/slider/3.jpeg') }}" />
                </div>
            </div>
